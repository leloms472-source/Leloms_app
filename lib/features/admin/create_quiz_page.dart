  ...
  Future<void> _save() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('quizzes').add({
        ...
        'createdBy': context.read<UserProvider>().userName,
      });
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'Título del Quiz', labelStyle: TextStyle(color: AppColors.secondaryText)),
                ),
                const SizedBox(height: 12),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'Tiempo (minutos)', labelStyle: TextStyle(color: AppColors.secondaryText)),
                ),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Center(child: Text('${index + 1}', style: const TextStyle(color: AppColors.primary, fontSize: 12, fontWeight: FontWeight.bold))),
              ),
              const Spacer(),
          ...
          TextField(
            ...
            style: const TextStyle(color: AppColors.lightText),
            maxLines: 3,
            decoration: const InputDecoration(labelText: 'Pregunta', labelStyle: TextStyle(color: AppColors.secondaryText), hintText: 'Escribe la pregunta aquí...', hintStyle: TextStyle(color: AppColors.secondaryText)),
          ),
          const SizedBox(height: 12),
          ...
          TextField(
            ...
            style: const TextStyle(color: AppColors.lightText),
            maxLines: 2,
            decoration: const InputDecoration(labelText: 'Explicación (opcional)', labelStyle: TextStyle(color: AppColors.secondaryText)),
          ),
        ],
      ),
    );
      ...
      child: Row(
        children: [
          GestureDetector(
            ...
            child: Container(
              width: 32, height: 32,
              decoration: BoxDecoration(shape: BoxShape.circle, color: isCorrect ? AppColors.success : AppColors.darkCard, border: Border.all(color: isCorrect ? AppColors.success : AppColors.border)),
              child: Center(child: Text(letters[index], style: TextStyle(color: isCorrect ? Colors.white : AppColors.secondaryText, fontSize: 12, fontWeight: FontWeight.bold))),
            ),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: TextField(
              controller: _optionCtrl(q, index),
              style: const TextStyle(color: AppColors.lightText, fontSize: 13),
              decoration: InputDecoration(
                hintText: 'Opción ${letters[index]}',
